...
public class M1Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case M1Package.CLIENT_SERVER_SYSTEM: {
			Client_Server_System client_Server_System = (Client_Server_System) theEObject;
			T result = caseClient_Server_System(client_Server_System);
			if (result == null)
				result = caseConfiguration(client_Server_System);
			if (result == null)
				result = caseArchitecturalElement(client_Server_System);
			if (result == null)
		...
		case M1Package.CLIENT: {
			...
			if (result == null)
				result = caseArchitecturalElement(client);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case M1Package.SERVER: {
			...
			if (result == null)
				result = caseArchitecturalElement(server);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case M1Package.RPC: {
			...
			if (result == null)
				result = caseArchitecturalElement(rpc);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Client Server System</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Client Server System</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseClient_Server_System(Client_Server_System object) {
		return null;
	}
