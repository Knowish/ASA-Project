 ...
 * </p>
 * <ul>
 *   <li>{@link asaproject.model.asa.M2.Connector#getGlue <em>Glue</em>}</li>
 *   <li>{@link asaproject.model.asa.M2.Connector#getIconnectors <em>Iconnectors</em>}</li>
 * </ul>
 *
 * @see asaproject.model.asa.M2.M2Package#getConnector()
 * @model
 * @generated
 */
public interface Connector extends ArchitecturalElement {
	 ...
	 * @see #setGlue(Glue)
	 * @see asaproject.model.asa.M2.M2Package#getConnector_Glue()
	...
	/**
	 * Sets the value of the '{@link asaproject.model.asa.M2.Connector#getGlue <em>Glue</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link asaproject.model.asa.M2.IConnector}.
	 * It is bidirectional and its opposite is '{@link asaproject.model.asa.M2.IConnector#getConnector <em>Connector</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see asaproject.model.asa.M2.M2Package#getConnector_Iconnectors()
