 ...
 * </p>
 * <ul>
 *   <li>{@link asaproject.model.asa.impl.ComponentImpl#getConfiguration <em>Configuration</em>}</li>
 *   <li>{@link asaproject.model.asa.impl.ComponentImpl#getIcomponents <em>Icomponents</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentImpl extends ArchitecturalElementImpl implements Component {
		...
		if (configuration != null && configuration.eIsProxy()) {
			...
			if (configuration != oldConfiguration) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AsaPackage.COMPONENT__CONFIGURATION,
	...
	public void setConfiguration(Configuration newConfiguration) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AsaPackage.COMPONENT__CONFIGURATION, oldConfiguration,
					configuration));
	}
	...
	public EList<IComponent> getIcomponents() {
		if (icomponents == null) {
			icomponents = new EObjectContainmentWithInverseEList<IComponent>(IComponent.class, this,
					AsaPackage.COMPONENT__ICOMPONENTS, AsaPackage.ICOMPONENT__COMPONENT);
		}
		return icomponents;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case AsaPackage.COMPONENT__ICOMPONENTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case AsaPackage.COMPONENT__CONFIGURATION:
			if (resolve)
