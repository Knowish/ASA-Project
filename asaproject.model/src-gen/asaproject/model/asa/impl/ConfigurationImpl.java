 ...
 * </p>
 * <ul>
 *   <li>{@link asaproject.model.asa.impl.ConfigurationImpl#getComponents <em>Components</em>}</li>
 *   <li>{@link asaproject.model.asa.impl.ConfigurationImpl#getConnectors <em>Connectors</em>}</li>
 *   <li>{@link asaproject.model.asa.impl.ConfigurationImpl#getPorts <em>Ports</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigurationImpl extends ArchitecturalElementImpl implements Configuration {
	...
	public EList<Component> getComponents() {
		if (components == null) {
			components = new EObjectResolvingEList<Component>(Component.class, this,
					AsaPackage.CONFIGURATION__COMPONENTS);
		}
		return components;
	}
	...
	public EList<Connector> getConnectors() {
		if (connectors == null) {
			connectors = new EObjectResolvingEList<Connector>(Connector.class, this,
					AsaPackage.CONFIGURATION__CONNECTORS);
		}
		return connectors;
	}
	...
	public EList<Port> getPorts() {
		if (ports == null) {
			ports = new EObjectContainmentWithInverseEList<Port>(Port.class, this, AsaPackage.CONFIGURATION__PORTS,
					AsaPackage.PORT__CONFIGURATION);
		}
		return ports;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case AsaPackage.CONFIGURATION__PORTS:
